...
<body>
	<header class="cabecalho">
		<a onclick="location.href='/sysgeventos/app/rolebsb/home'"><h1 class="logo">RolêBSB</h1></a>
		...
		<nav class="menu">
			...
			<ul>
				<li><button onclick="location.href='/sysgeventos/app/rolebsb/home'" ><a>Eventos</a></button></li>
				<li><button onclick="location.href='/sysgeventos/app/rolebsb/noticias'"><a>Notícias</a></button></li>
				<li><button onclick="location.href='/sysgeventos/app/rolebsb/sobre'" ><a>Sobre nós</a></button></li>
				<li><button onclick="location.href='/sysgeventos/app/rolebsb/login'"><a>Acessar</a></button></li>
			</ul>
		</nav>
	</header>
