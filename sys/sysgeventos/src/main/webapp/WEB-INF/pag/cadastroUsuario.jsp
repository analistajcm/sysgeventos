	...
	<div class="panel">
		<c:if test='${not empty param["cadastroerro"]}'>
			<div class="alert alert-warning">
				Campo(s) obrigatório(s) não informado!
				Os campos obrigatórios são aqueles que tem asterisco.
			</div>
		</c:if>
		...
		<form method="post" action="cadastro">
						...
						<div class="modal-header">
							...
							<label class="control-label" name="endereco">Endereço*:</label>
							...
							<label class="radio-inline"><input type="radio" value="false" id="organizador" name="organizador">Usuário</label>
